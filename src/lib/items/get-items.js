...
function getItems(urls, total, progressBar) {
  return __awaiter(this, void 0, void 0, function () {
    var spotify, accessToken, requests, items
    var _this = this
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          spotify = _a.sent()
          return [4 /*yield*/, spotify.getAccessToken()]
        case 2:
          accessToken = _a.sent()
          if (!accessToken) {
          ...
          requests = urls.map(function (url) {
            return fetch(url, {
              headers: {
                Authorization: 'Bearer '.concat(accessToken.access_token),
              },
              method: 'GET',
            })
          })
